...
MANUAL_FIELDS = [
    ...
    },
    {
        ...
        "help": "Raw AAA-GSec spread in bps (e.g. 73). Compute auto-converts to 5Y percentile.",
        "cadence": "Monthly",
        "source_url": "https://indiamacroindicators.co.in/economic-indicators/10-year-credit-spread-aaa-rated-bonds-g-sec",
        "source_label": "India Macro AAA spread (raw bps)",
    },
    {
    ...
    },
    {
        ...
        "source_label": "NSDL FPI monthly flows",
    },
    {
        ...
        "help": "Single latest month's DII net flow in Cr (e.g. 45000). Compute uses as 30D proxy.",
        "cadence": "Monthly",
        "source_url": "https://www.amfiindia.com/research-information/amfi-monthly",
        "source_label": "AMFI MF flows / NSE DII",
    },
    {
        "key": "sip_yoy",
        "label": "SIP YoY (%)",
